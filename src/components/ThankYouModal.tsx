  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Wedding Group Photo */}
        <div className="relative w-full aspect-16/10 sm:aspect-16/9 bg-amber-100 overflow-hidden">
          <img
          ...
          <div className="absolute bottom-2.5 left-3 right-3 text-white flex items-center justify-between text-xs sm:text-sm font-medium drop-shadow-md">
            <span className="flex items-center gap-1.5 font-semibold">
              <span>🍋</span>
              <span>Katia & Jean-François</span>
              <span>🍕</span>
            </span>
            <span className="opacity-90">25 Juillet 2026</span>
          </div>
        </div>
